...
import { BasePokemon, TypeColor, TypeMap } from '@/models';
    ...
    <>
      <div className="grid grid-cols-12 gap-3">
        ...
        <div className="col-span-12 space-y-3 md:col-span-7">
          ...
          />
          <table className="w-full table-fixed text-center text-sm text-gray-100">
        ...
        <ul className="col-span-12 text-center text-sm text-gray-100 md:text-start">
